...
var NodeMaterialBlock = /** @class */ (function () {
    ...
    NodeMaterialBlock.prototype.registerInput = function (name, type, isOptional, target) {
        ...
        var point = new NodeMaterialConnectionPoint(name, this, NodeMaterialConnectionPointDirection.Input);
        point.type = type;
    ...
    NodeMaterialBlock.prototype.registerOutput = function (name, type, target) {
        var point = new NodeMaterialConnectionPoint(name, this, NodeMaterialConnectionPointDirection.Output);
        point.type = type;
        if (target) {
            point.target = target;
        }
