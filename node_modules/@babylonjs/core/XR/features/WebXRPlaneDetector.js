...
var WebXRPlaneDetector = /** @class */ (function (_super) {
    ...
    WebXRPlaneDetector.prototype._onXRFrame = function (frame) {
        ...
        if (detectedPlanes && detectedPlanes.size) {
            this._detectedPlanes.filter(function (plane) { return !detectedPlanes.has(plane.xrPlane); }).map(function (plane) {
                var index = _this._detectedPlanes.indexOf(plane);
                _this._detectedPlanes.splice(index, 1);
