...
var WebXRMotionControllerTeleportation = /** @class */ (function (_super) {
        ...
        _this._attachController = function (xrController) {
            ...
            xrController.onMotionControllerInitObservable.addOnce(function () {
                if (xrController.motionController) {
                    var movementController_1 = xrController.motionController.getComponentOfType(WebXRControllerComponent.THUMBSTICK_TYPE) || xrController.motionController.getComponentOfType(WebXRControllerComponent.TOUCHPAD_TYPE);
                    if (!movementController_1 || _this._options.useMainComponentOnly) {
                        ...
                        controllerData.onButtonChangedObserver = mainComponent_1.onButtonStateChangedObservable.add(function () {
                            ...
                            if (mainComponent_1.changes.pressed) {
                                if (mainComponent_1.changes.pressed.current) {
                                    ...
                                    var timeToSelect_1 = _this._options.timeToTeleport || 3000;
                                    var timer_1 = 0;
                                    var observer_1 = _this._xrSessionManager.onXRFrameObservable.add(function () {
                                        if (!mainComponent_1.pressed) {
                                            _this._xrSessionManager.onXRFrameObservable.remove(observer_1);
                                            return;
                                        }
                                        timer_1 += _this._xrSessionManager.scene.getEngine().getDeltaTime();
                                        if (timer_1 >= timeToSelect_1 && _this._currentTeleportationControllerId === controllerData.xrController.uniqueId && controllerData.teleportationState.forward) {
                                            _this._teleportForward(xrController.uniqueId);
                                        }
                                        // failsafe
                                        if (timer_1 >= timeToSelect_1) {
                                            _this._xrSessionManager.onXRFrameObservable.remove(observer_1);
                                        }
                                    });
                                }
                        ...
                        controllerData.onButtonChangedObserver = movementController_1.onButtonStateChangedObservable.add(function () {
                            if (_this._currentTeleportationControllerId === controllerData.xrController.uniqueId && controllerData.teleportationState.forward && !movementController_1.touched) {
                                _this._teleportForward(xrController.uniqueId);
                            }
                        });
                        // use thumbstick (or touchpad if thumbstick not available)
                        controllerData.onAxisChangedObserver = movementController_1.onAxisValueChangedObservable.add(function (axesData) {
                            ...
                            if (axesData.y > 0.7 && !controllerData.teleportationState.forward && _this.backwardsMovementEnabled && !_this.snapPointsOnly) {
                                ...
                                if (!controllerData.teleportationState.backwards) {
                                    ...
                                    _this._tmpVector.set(0, 0, _this.backwardsTeleportationDistance);
                                    _this._tmpVector.rotateByQuaternionToRef(_this._options.xrInput.xrCamera.rotationQuaternion, _this._tmpVector);
                                    _this._tmpVector.addInPlace(_this._options.xrInput.xrCamera.position);
                                    _this._options.xrInput.xrCamera.position.subtractToRef(_this._tmpVector, _this._tmpVector);
                                    ...
                                    if (pick && pick.pickedPoint) {
                                        ...
                                        _this._options.xrInput.xrCamera.position.addInPlace(pick.pickedPoint);
                                    }
                                }
                            }
                            ...
                            if (axesData.x) {
                                if (!controllerData.teleportationState.forward) {
                                    if (!controllerData.teleportationState.rotating && Math.abs(axesData.x) > 0.7) {
                                        ...
                                        var rotation = _this.rotationAngle * (axesData.x > 0 ? 1 : -1);
    ...
    WebXRMotionControllerTeleportation.prototype._setTargetMeshVisibility = function (visible) {
        ...
        this._options.teleportationTargetMesh.getChildren(undefined, false).forEach(function (m) { (m).isVisible = visible; });
        if (!visible) {
