...
var EffectLayer = /** @class */ (function () {
    ...
    EffectLayer.prototype._renderSubMesh = function (subMesh, enableAlphaMode) {
        ...
        if (this._useMeshMaterial(mesh)) {
            ...
            // Draw
            mesh._processRendering(subMesh, this._effectLayerMapGenerationEffect, material.fillMode, batch, hardwareInstancedRendering, function (isInstance, world) { return _this._effectLayerMapGenerationEffect.setMatrix("world", world); });
        }
        else {
