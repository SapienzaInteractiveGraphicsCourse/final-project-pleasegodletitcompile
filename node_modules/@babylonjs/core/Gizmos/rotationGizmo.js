...
var RotationGizmo = /** @class */ (function (_super) {
    ...
    function RotationGizmo(gizmoLayer, tessellation, useEulerRotation) {
        ...
        _this.xGizmo = new PlaneRotationGizmo(new Vector3(1, 0, 0), Color3.Red().scale(0.5), gizmoLayer, tessellation, _this, useEulerRotation);
        _this.yGizmo = new PlaneRotationGizmo(new Vector3(0, 1, 0), Color3.Green().scale(0.5), gizmoLayer, tessellation, _this, useEulerRotation);
        _this.zGizmo = new PlaneRotationGizmo(new Vector3(0, 0, 1), Color3.Blue().scale(0.5), gizmoLayer, tessellation, _this, useEulerRotation);
        // Relay drag events
