...
var tmpv1 = new Vector3(), tmpv2 = new Vector3(), matrix = new Matrix();
/**
...
var CascadedShadowGenerator = /** @class */ (function (_super) {
    ...
    function CascadedShadowGenerator(mapSize, light, usefulFloatFirst) {
        ...
        if (_this._scene.getEngine().webGLVersion == 1) {
    ...
    CascadedShadowGenerator.prototype._initializeGenerator = function () {
        ...
        this.penumbraDarkness = (_a = this.penumbraDarkness, (_a !== null && _a !== void 0 ? _a : 1.0));
        this._numCascades = (_b = this._numCascades, (_b !== null && _b !== void 0 ? _b : CascadedShadowGenerator.DEFAULT_CASCADES_COUNT));
        this.stabilizeCascades = (_c = this.stabilizeCascades, (_c !== null && _c !== void 0 ? _c : false));
        this._freezeShadowCastersBoundingInfoObservable = (_d = this._freezeShadowCastersBoundingInfoObservable, (_d !== null && _d !== void 0 ? _d : null));
        this.freezeShadowCastersBoundingInfo = (_e = this.freezeShadowCastersBoundingInfo, (_e !== null && _e !== void 0 ? _e : false));
        this._scbiMin = (_f = this._scbiMin, (_f !== null && _f !== void 0 ? _f : new Vector3(0, 0, 0)));
        this._scbiMax = (_g = this._scbiMax, (_g !== null && _g !== void 0 ? _g : new Vector3(0, 0, 0)));
        this._shadowCastersBoundingInfo = (_h = this._shadowCastersBoundingInfo, (_h !== null && _h !== void 0 ? _h : new BoundingInfo(new Vector3(0, 0, 0), new Vector3(0, 0, 0))));
        this._breaksAreDirty = (_j = this._breaksAreDirty, (_j !== null && _j !== void 0 ? _j : true));
        this._minDistance = (_k = this._minDistance, (_k !== null && _k !== void 0 ? _k : 0));
        this._maxDistance = (_l = this._maxDistance, (_l !== null && _l !== void 0 ? _l : 1));
        this._currentLayer = (_m = this._currentLayer, (_m !== null && _m !== void 0 ? _m : 0));
        this._shadowMaxZ = (_q = (_o = this._shadowMaxZ, (_o !== null && _o !== void 0 ? _o : (_p = this._scene.activeCamera) === null || _p === void 0 ? void 0 : _p.maxZ)), (_q !== null && _q !== void 0 ? _q : 10000));
        this._debug = (_r = this._debug, (_r !== null && _r !== void 0 ? _r : false));
        this._depthClamp = (_s = this._depthClamp, (_s !== null && _s !== void 0 ? _s : true));
        this._cascadeBlendPercentage = (_t = this._cascadeBlendPercentage, (_t !== null && _t !== void 0 ? _t : 0.1));
        this._lambda = (_u = this._lambda, (_u !== null && _u !== void 0 ? _u : 0.5));
        this._autoCalcDepthBounds = (_v = this._autoCalcDepthBounds, (_v !== null && _v !== void 0 ? _v : false));
