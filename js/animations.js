...
function snowMan(){
    ...
    keys = [];
    keys.push({ frame: 0, value: new BABYLON.Vector3(snowRA._rotation[0],0,4.7)});
    keys.push({ frame: 0.25*framerate, value: new BABYLON.Vector3(snowRA._rotation[0],0,5.1) });
    keys.push({ frame: 0.5*framerate, value: new BABYLON.Vector3(snowRA._rotation[0],0,5.7) });
    keys.push({ frame: 0.75*framerate, value: new BABYLON.Vector3(snowRA._rotation[0],0,5.1) });
    keys.push({ frame: framerate, value: new BABYLON.Vector3(snowRA._rotation[0],0,4.7) });
    ...
    keys = [];
    keys.push({ frame: 0, value: new BABYLON.Vector3(snowRA2._rotation[0],0,4.7)});
    keys.push({ frame: 0.25*framerate, value: new BABYLON.Vector3(snowRA2._rotation[0],0,5.1) });
    keys.push({ frame: 0.5*framerate, value: new BABYLON.Vector3(snowRA2._rotation[0],0,5.7) });
    keys.push({ frame: 0.75*framerate, value: new BABYLON.Vector3(snowRA2._rotation[0],0,5.1) });
    keys.push({ frame: framerate, value: new BABYLON.Vector3(snowRA2._rotation[0],0,4.7) });
